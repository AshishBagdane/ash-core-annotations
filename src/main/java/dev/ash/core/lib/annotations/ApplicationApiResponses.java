...
/**
 * Standardized API response documentation annotation for REST controllers. This annotation provides a consistent way to document common HTTP response scenarios across all API endpoints. It
 * automatically includes documentation for successful responses and common error scenarios.
 *
...
public @interface ApplicationApiResponses {
  ...
  /**
   * Allows overriding the media type for the successful response (200). Defaults to "application/json" if not specified.
   *
